...
IMPLEMENTED_MODELS: tuple[str, ...] = ("M1", "M2", "M3")
...
_FACTORIES = {"M1": make_m1, "M2": make_m2, "M3": make_m3}
...
class ProbabilityReport:
    ...
    def rows_sum_to_one(self) -> bool:
        return self.max_row_sum_error <= 1e-9
    ...
    def problems(self) -> tuple[str, ...]:
        ...
        if not self.rows_sum_to_one:
            found.append("row sums off by up to " + repr(self.max_row_sum_error))
